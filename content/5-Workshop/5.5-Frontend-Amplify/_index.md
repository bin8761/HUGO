...
![Amazon API Gateway HTTP API overview](/HUGO/images/5-Workshop/5.5-Frontend-Amplify/5.5.1-api-gateway-overview.png)
...
![API Gateway proxy route](/HUGO/images/5-Workshop/5.5-Frontend-Amplify/5.5.2-api-gateway-route.png)
...
![API Gateway integration pointing to Elastic Beanstalk](/HUGO/images/5-Workshop/5.5-Frontend-Amplify/5.5.3-api-gateway-integration.png)
...
![Health endpoint through API Gateway](/HUGO/images/5-Workshop/5.5-Frontend-Amplify/5.5.4-api-gateway-health.png)
...
![Amplify build settings](/HUGO/images/5-Workshop/5.5-Frontend-Amplify/5.5.6-amplify-build-settings.png)
...
![Amplify app connected to the aws-architecture branch](/HUGO/images/5-Workshop/5.5-Frontend-Amplify/5.5.5-amplify-branch.png)
...
![Successful Amplify deployment](/HUGO/images/5-Workshop/5.5-Frontend-Amplify/5.5.8-amplify-build-success.png)
...
![Amplify rewrite rules](/HUGO/images/5-Workshop/5.5-Frontend-Amplify/5.5.7-amplify-rewrite-rules.png)
...
![Health endpoint through the Amplify domain](/HUGO/images/5-Workshop/5.5-Frontend-Amplify/5.5.9-amplify-health.png)
