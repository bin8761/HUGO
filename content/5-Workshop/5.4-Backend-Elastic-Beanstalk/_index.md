...
![Backend source bundle with the correct Elastic Beanstalk deployment structure](/HUGO/images/5-Workshop/5.4-Backend-Elastic-Beanstalk/5.4.1-source-bundle.png)
...
![Elastic Beanstalk environment creation page for the backend](/HUGO/images/5-Workshop/5.4-Backend-Elastic-Beanstalk/5.4.2-create-eb-environment.png)
...
![Elastic Beanstalk environment properties](/HUGO/images/5-Workshop/5.4-Backend-Elastic-Beanstalk/5.4.4-eb-env-properties.png)
...
![Elastic Beanstalk environment in OK status](/HUGO/images/5-Workshop/5.4-Backend-Elastic-Beanstalk/5.4.3-eb-health-ok.png)
...
![Backend health endpoint on Elastic Beanstalk](/HUGO/images/5-Workshop/5.4-Backend-Elastic-Beanstalk/5.4.5-eb-health-endpoint.png)
